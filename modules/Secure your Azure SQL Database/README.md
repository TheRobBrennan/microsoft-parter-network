...
- [Manage IP firewall rules for Azure SQL Server](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-firewall-configure)
- [Manage Advanced Data Security settings for a SQL database](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-advanced-data-security)
