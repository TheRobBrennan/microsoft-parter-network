...
To verify your implementation, you can reference the end folder or you can view the code on GitHub.

### Additional Resources

Learn more about [Azure Cosmos DB input bindings for Azure Functions](https://docs.microsoft.com/en-us/azure/azure-functions/functions-bindings-cosmosdb-v2)
